   ...
   public sealed class Sales : Salary
    {
        ...
        public Sales(uint employeeId, string employeeType, string firstName, string lastName, double monthlySalary, double commission, double grossSales) : base(employeeId, employeeType, firstName, lastName, monthlySalary)
        {
