...
namespace EmployeeDB
{
     class Salary:Employee
    {
      ...
      /// <summary>
        ...
        public Salary(int employeeId,string employeeType, string firstName, string lastName, double monthlySalary):base(employeeId, employeeType,firstName,lastName)
        {
